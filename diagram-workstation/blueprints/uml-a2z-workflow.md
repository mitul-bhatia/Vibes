...
2. Generate each required diagram under diagrams/src:
   - 01-class-diagram.drawio
   - 02-object-diagram.drawio
   - 03-use-case-diagram.drawio
   - 04-activity-diagram.drawio
   - 05-sequence-diagram.drawio
3. Generate 06-erd-diagram.drawio when database modeling is needed.
...
3. Review updated .drawio files and verify IDs stay stable.

## Phase 4: Packaging

1. Validate manifest and required files:
   npm run diagrams:validate
2. Export all diagrams and build merged book:
